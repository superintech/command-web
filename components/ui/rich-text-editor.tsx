  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isActive && 'bg-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))]'
      )}
    >
      {children}
    </Button>
    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          'prose-headings:text-[hsl(var(--text-primary))] prose-strong:text-[hsl(var(--text-primary))]',
          ...
          '[&_.tiptap-placeholder]:text-[hsl(var(--text-muted))]'
        ),
