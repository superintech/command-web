        ...
        <div className="flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="icon" className="text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-[hsl(var(--layout-bg))] border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))]">
              {room.type !== 'DIRECT' && (
                <>
                  <DropdownMenuItem className="hover:bg-[hsl(var(--layout-card-hover))]/50 cursor-pointer focus:bg-[hsl(var(--layout-card-hover))]/50">
                  ...
                  <DropdownMenuItem
                    className="text-red-400 hover:bg-[hsl(var(--layout-card-hover))]/50 cursor-pointer focus:bg-[hsl(var(--layout-card-hover))]/50 focus:text-red-400"
                    onClick={onLeaveRoom}
                  >
            ...
            {groupedMessages.map((group, groupIndex) => (
              <div key={groupIndex}>
                ...
                <div className="flex items-center gap-2 my-4">
                  <div className="flex-1 h-px bg-[hsl(var(--layout-border))]" />
                ...
                {group.messages.map((msg, index) => {
                  ...
                  return (
                    <div
                      key={msg.id}
                      className={cn(
                        'group relative hover:bg-[hsl(var(--layout-card-hover))]/30 rounded px-2 py-0.5',
                      ...
                      <div className="flex gap-4">
                        {showHeader ? (
                          ...
                          <div className="w-10 flex items-center justify-center">
                            <span className="text-[10px] text-[hsl(var(--text-secondary))] opacity-0 group-hover:opacity-100">
                            ...
                            <div className="mt-2 max-w-md">
                              {msg.file.mimeType.startsWith('image/') ? (
                                ...
                                <a
                                  ...
                                  className="flex items-center gap-3 p-3 bg-[hsl(var(--layout-bg))] rounded-lg hover:bg-[hsl(var(--layout-card-hover))]/50 transition-colors border border-[hsl(var(--layout-border))]"
                                >
                              ...
                              {Object.entries(
                                ...
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    'bg-[hsl(var(--layout-bg))] hover:bg-[hsl(var(--layout-card-hover))]/50 border border-[hsl(var(--layout-border))]',
                        ...
                        <div className="opacity-0 group-hover:opacity-100 absolute right-2 -top-3 flex items-center gap-0.5 bg-[hsl(var(--layout-bg))] rounded border border-[hsl(var(--layout-border))]">
                          {REACTION_EMOJIS.slice(0, 4).map((emoji) => (
                            <button
                              key={emoji}
                              onClick={() => handleReaction(msg.id, emoji)}
                              className="p-1 hover:bg-[hsl(var(--layout-card-hover))]/50 rounded text-sm"
                            >
                              {emoji}
                            </button>
                          ))}
      ...
      <div className="p-4">
        <div className="flex items-center gap-2 bg-[hsl(var(--layout-bg))] border border-[hsl(var(--layout-border))] rounded-lg px-4 py-2">
          ...
          <Button
            ...
            className="text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50 h-8 w-8"
          >
