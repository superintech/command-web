            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="text-xs text-[hsl(var(--text-secondary))]">Try:</span>
              ...
              {generatedTask && (
                <Card className="bg-[hsl(var(--layout-card))]/50 border-[hsl(var(--layout-border))]">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-[hsl(var(--text-primary))] whitespace-pre-wrap bg-slate-900/50 p-3 rounded-lg">
                        {generatedTask.description}
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-1">
                          {generatedTask.subtasks.map((subtask, idx) => (
                            <li
                              key={idx}
                              className="flex items-center gap-2 text-sm text-[hsl(var(--text-primary))] bg-slate-900/30 px-3 py-2 rounded"
                            >
                              <ChevronRight className="h-3 w-3 text-[hsl(var(--text-secondary))]" />
                              {subtask}
                            </li>
                          ))}
                        </ul>
...
- Review the API documentation before release`}
        ...
        {/* Footer Info */}
        <div className="flex items-center gap-2 text-xs text-[hsl(var(--text-secondary))] pt-2 border-t border-[hsl(var(--layout-border))]">
