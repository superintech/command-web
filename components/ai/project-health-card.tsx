    ...
    return (
      <Card className={cn('bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]', className)}>
        <CardContent className="flex flex-col items-center justify-center h-48 gap-3">
          <Activity className="h-8 w-8 text-[hsl(var(--text-secondary))]" />
    ...
    <Card className={cn('bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]', className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-[hsl(var(--layout-card))]/50 rounded-lg p-2 text-center">
        ...
        <div>
          ...
          <Progress
            ...
            className="h-2 bg-[hsl(var(--layout-border))]"
          />
        </div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              {analysis.risks.slice(0, 3).map((risk, idx) => (
                <li
                  key={idx}
                  className="text-xs text-[hsl(var(--text-secondary))] bg-[hsl(var(--layout-card))]/50 px-3 py-2 rounded"
                >
                  {risk}
                </li>
              ))}
