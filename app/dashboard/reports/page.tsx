  ...
  return (
    <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))] hover:border-[hsl(var(--layout-border))] transition-colors">
      <CardContent className="p-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="mt-2 flex items-baseline">
              ...
              <p className="ml-1 text-sm text-[hsl(var(--text-secondary))]">/{max}</p>
            </div>
            {description && (
        ...
        <div className="mt-4 h-2 rounded-full bg-[hsl(var(--layout-border))]">
          <div
...
function EODRCard({ entry, onReview }: { entry: EODREntry; onReview?: () => void }) {
  ...
  return (
    <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))] hover:border-[hsl(var(--layout-border))] transition-all duration-200 hover:-translate-y-0.5">
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            {onReview && (
              <Button variant="ghost" size="sm" onClick={onReview} className="text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50">
        ...
        {Array.isArray(entry.tasks) && entry.tasks.length > 0 && (
          <div className="mt-3 space-y-1">
            {entry.tasks.slice(0, 3).map((task, idx) => (
              <div key={idx} className="text-xs text-[hsl(var(--text-primary))] truncate">
                <span className="font-medium">{task.title}</span>
                <span className="text-[hsl(var(--text-secondary))] ml-1">({task.hours.toFixed(1)}h)</span>
                {task.pendingItems && (
        ...
        {entry.notes && (
          <p className="mt-2 text-xs text-[hsl(var(--text-secondary))] italic border-t border-[hsl(var(--layout-border))] pt-2">
            {entry.notes}
          </p>
        )}
      </CardContent>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <Select value={selectedMonth.toString()} onValueChange={(v) => setSelectedMonth(parseInt(v))}>
              ...
              <SelectContent className="bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                {MONTHS.map((month, idx) => (
                  <SelectItem key={idx} value={(idx + 1).toString()} className="text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50 focus:bg-[hsl(var(--layout-card-hover))]/50">
                    {month}
                  </SelectItem>
                ))}
              </SelectContent>
            ...
            <Select value={selectedYear.toString()} onValueChange={(v) => setSelectedYear(parseInt(v))}>
              ...
              <SelectContent className="bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                {years.map((year) => (
                  <SelectItem key={year} value={year.toString()} className="text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50 focus:bg-[hsl(var(--layout-card-hover))]/50">
                    {year}
                  </SelectItem>
                ))}
              </SelectContent>
      ...
      <Tabs defaultValue={userIsManager ? "eodr-table" : "my-kpi"}>
          ...
          {loadingMyKpi ? (
            ...
            <>
              {myKpi.commissionTier && (
                <Card className="bg-gradient-to-r from-[hsl(var(--layout-card))] to-[hsl(var(--layout-card-hover))] border-[hsl(var(--layout-border))]">
                  ...
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-4 mb-4">
                      <div className="text-center p-3 bg-blue-500/20 rounded border border-blue-500/30">
                        ...
                        <p className="text-sm text-[hsl(var(--text-secondary))]">Avg Attendance</p>
                      </div>
                      <div className="text-center p-3 bg-green-500/20 rounded border border-green-500/30">
                        ...
                        <p className="text-sm text-[hsl(var(--text-secondary))]">Avg Quality</p>
                      </div>
                      <div className="text-center p-3 bg-pink-500/20 rounded border border-pink-500/30">
                        ...
                        <p className="text-sm text-[hsl(var(--text-secondary))]">Avg Behaviour</p>
                      </div>
                      <div className="text-center p-3 bg-purple-500/20 rounded border border-purple-500/30">
                        ...
                        <p className="text-sm text-[hsl(var(--text-secondary))]">Avg EODR</p>
                      </div>
                    </div>
                  ...
                  <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-[hsl(var(--text-secondary))]">/100</span>
                      </div>
                      <div className="h-4 rounded-full bg-[hsl(var(--layout-border))]">
                        <div
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {submitTasks.map((task, idx) => (
                  <Card key={idx} className="p-4 bg-[hsl(var(--layout-bg))] border-[hsl(var(--layout-border))]">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="font-medium text-sm text-[hsl(var(--text-secondary))]">Task #{idx + 1}</span>
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          <Label htmlFor={`task-title-${idx}`} className="text-[hsl(var(--text-primary))]">Task Title *</Label>
                          <Input
                            id={`task-title-${idx}`}
                            value={task.title}
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`task-project-${idx}`} className="text-[hsl(var(--text-primary))]">Project</Label>
                          <select
                            id={`task-project-${idx}`}
                      ...
                      {task.projectId && (
                        <div className="space-y-2">
                          <Label htmlFor={`task-select-${idx}`} className="text-[hsl(var(--text-primary))]">Select Task (Optional - auto-fills hours)</Label>
                          <select
                            id={`task-select-${idx}`}
                            value={task.taskId}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor={`task-desc-${idx}`} className="text-[hsl(var(--text-primary))]">Description - What was done? <span className="text-red-400">*</span></Label>
                        <Textarea
                          id={`task-desc-${idx}`}
                      ...
                      <div className="grid gap-4 md:grid-cols-3">
                        <div className="space-y-2">
                          <Label htmlFor={`task-hours-${idx}`} className="text-[hsl(var(--text-primary))]">Hours Spent</Label>
                          <Input
                            id={`task-hours-${idx}`}
                            type="number"
                            step="0.5"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`task-status-${idx}`} className="text-[hsl(var(--text-primary))]">Status</Label>
                          <select
                            id={`task-status-${idx}`}
                            value={task.status}
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`task-completed-${idx}`} className="text-[hsl(var(--text-primary))]">Completed At</Label>
                          <Input
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          <Label htmlFor={`task-files-${idx}`} className="text-[hsl(var(--text-primary))]">Files/Documents Location</Label>
                          <Input
                            id={`task-files-${idx}`}
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`task-pending-${idx}`} className="text-[hsl(var(--text-primary))]">What&apos;s Pending?</Label>
                          <Input
                            id={`task-pending-${idx}`}
              ...
              {/* Notes */}
              <div className="space-y-2">
                <Label htmlFor="submit-notes" className="text-[hsl(var(--text-primary))]">Additional Notes (Optional)</Label>
                <Textarea
                  id="submit-notes"
                  value={submitNotes}
              ...
              <div className="bg-blue-500/20 p-4 rounded-lg border border-blue-500/30">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <p className="text-xs text-[hsl(var(--text-secondary))]">Tasks</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-green-400">{submitTasks.reduce((sum, t) => sum + (t.hours || 0), 0).toFixed(1)}</p>
                    <p className="text-xs text-[hsl(var(--text-secondary))]">Total Hours</p>
                  </div>
                  <div>
          ...
          {userIsManager && (
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <SelectContent className="bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                  <SelectItem value="all" className="text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50 focus:bg-[hsl(var(--layout-card-hover))]/50">All Users</SelectItem>
                  {users.map((u) => (
                    <SelectItem key={u.id} value={u.id} className="text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50 focus:bg-[hsl(var(--layout-card-hover))]/50">
                      {u.name}
                    </SelectItem>
                  ))}
                </SelectContent>
                ...
                <div className="grid gap-4 md:grid-cols-5">
                  ...
                  <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                    <CardContent className="p-4 text-center">
                      ...
                      <p className="text-sm text-[hsl(var(--text-secondary))]">Submitted EODR</p>
                    </CardContent>
                  </Card>
                  <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                    <CardContent className="p-4 text-center">
                      <p className="text-2xl font-bold text-red-400">{teamDaily.stats.pendingEODR}</p>
                      <p className="text-sm text-[hsl(var(--text-secondary))]">Missing EODR</p>
                    </CardContent>
                  </Card>
                  <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                    <CardContent className="p-4 text-center">
                      <p className="text-2xl font-bold text-blue-400">{teamDaily.stats.scored}</p>
                      <p className="text-sm text-[hsl(var(--text-secondary))]">Scored</p>
                    </CardContent>
                  </Card>
                  <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                    <CardContent className="p-4 text-center">
                      <p className="text-2xl font-bold text-orange-400">{teamDaily.stats.pendingScoring}</p>
                      <p className="text-sm text-[hsl(var(--text-secondary))]">Pending Score</p>
                    </CardContent>
                  </Card>
                </div>
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-[hsl(var(--layout-border))] bg-[hsl(var(--layout-bg))]">
                            <th className="text-left py-3 px-4 font-semibold text-[hsl(var(--text-primary))]">Employee</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">EODR</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Hours</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Tasks</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Attendance</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Quality</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Behaviour</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">EODR Score</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Total</th>
                            <th className="text-center py-3 px-2 font-semibold text-[hsl(var(--text-primary))]">Action</th>
                          </tr>
                        </thead>
                        <tbody>
                          {teamDaily.team.map((member) => (
                            <tr
                              key={member.user.id}
                              className={`border-b border-[hsl(var(--layout-border))]/50 hover:bg-[hsl(var(--layout-card-hover))]/30 ${
                            ...
                            >
                              ...
                              <td className="text-center py-3 px-2 text-sm text-[hsl(var(--text-primary))]">
        ...
        <TabsContent value="employee-of-month" className="space-y-6">
          ...
          {loadingEOM ? (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          ...
                          <div className="absolute -top-2 -right-2 bg-[hsl(var(--layout-card))] rounded-full p-1 border-2 border-yellow-400">
                        ...
                        <div>
                          ...
                          <h2 className="text-2xl font-bold text-[hsl(var(--text-primary))]">{eom.employeeOfMonth.user.name}</h2>
                          <p className="text-sm text-[hsl(var(--text-secondary))]">{eom.employeeOfMonth.user.department?.name}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-4xl font-bold text-yellow-400">{eom.employeeOfMonth.points.toFixed(1)}</p>
                        <p className="text-sm text-[hsl(var(--text-secondary))]">Total Points ({eom.employeeOfMonth.daysScored} days)</p>
              ...
              <div className="grid gap-4 md:grid-cols-4">
                ...
                <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-[hsl(var(--text-secondary))]">Eligible</p>
                  </CardContent>
                </Card>
                <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                  <CardContent className="p-4 text-center">
                    <p className="text-2xl font-bold text-red-400">{eom.stats?.ineligibleCount || 0}</p>
                    <p className="text-sm text-[hsl(var(--text-secondary))]">Below Average</p>
                  </CardContent>
                </Card>
              </div>
                  ...
                  {eom.employees.length > 0 ? (
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-[hsl(var(--layout-border))] bg-[hsl(var(--layout-bg))]">
                            <th className="text-left py-3 px-4 font-semibold text-[hsl(var(--text-primary))]">Name</th>
                            <th className="text-center py-3 px-4 font-semibold text-[hsl(var(--text-primary))]">Days Scored</th>
                            <th className="text-center py-3 px-4 font-semibold text-[hsl(var(--text-primary))]">Points</th>
                            <th className="text-center py-3 px-4 font-semibold text-[hsl(var(--text-primary))]">Avg Point</th>
                            <th className="text-center py-3 px-4 font-semibold text-[hsl(var(--text-primary))]">Difference</th>
                          </tr>
                        </thead>
                        <tbody>
                          {eom.employees.map((emp, idx) => (
                            <tr
                              key={emp.user.id}
                              className={`border-b border-[hsl(var(--layout-border))] ${
                    ...
                    <p className="text-center text-[hsl(var(--text-secondary))] py-8">
                      No daily KPI scores for this period. Managers need to score employees daily.
                    </p>
                  )}
                  <p className="mt-4 text-xs text-[hsl(var(--text-secondary))] italic">
            ...
            <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
              <CardContent className="flex flex-col items-center justify-center py-12">
                <Trophy className="h-12 w-12 text-[hsl(var(--text-secondary))]" />
                <h3 className="mt-4 text-lg font-medium text-[hsl(var(--text-secondary))]">No Data Available</h3>
              </CardContent>
            </Card>
          )}
        </TabsContent>
        ...
        <DialogContent className="max-w-lg bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
          ...
          {reviewingEntry && (
            <div className="space-y-4">
              ...
              <div className="bg-[hsl(var(--layout-bg))] p-3 rounded border border-[hsl(var(--layout-border))]">
                ...
                {Array.isArray(reviewingEntry.tasks) && reviewingEntry.tasks.map((task, idx) => (
                  <div key={idx} className="text-sm py-1 border-b border-[hsl(var(--layout-border))] last:border-0">
                    ...
                    <div className="flex gap-2 text-xs text-[hsl(var(--text-secondary))] mt-1">
              ...
              <div className="space-y-2">
                <Label className="text-[hsl(var(--text-primary))]">Adjust Hours (Original: {reviewingEntry.totalHours}h)</Label>
                <Input
                  type="number"
                  step="0.5"
                  value={adjustedHours}
              ...
              <div className="space-y-2">
                <Label className="text-[hsl(var(--text-primary))]">Manager Notes</Label>
                <Textarea
                  value={managerNotes}
              ...
              {reviewingEntry.notes && (
                <div className="bg-blue-500/10 p-3 rounded border border-blue-500/30">
                  ...
                  <p className="text-sm text-[hsl(var(--text-primary))]">{reviewingEntry.notes}</p>
                </div>
              )}
            </div>
          )}
          <DialogFooter className="flex gap-2">
            <Button variant="outline" onClick={() => setReviewingEntry(null)} className="border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50">
              Cancel
            </Button>
            <Button
              variant="outline"
              ...
              className="border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50"
            >
              Save Only
            </Button>
            <Button
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
          ...
          {scoringMember && (
            <div className="space-y-4 pr-2">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {[0, 1, 2].map((score) => (
                      <label key={score} className={`flex items-start gap-3 p-2 rounded cursor-pointer border ${dailyScoreValues.attendance === score ? 'bg-blue-500/20 border-blue-500/50' : 'bg-[hsl(var(--layout-bg))] border-[hsl(var(--layout-border))] hover:bg-[hsl(var(--layout-card-hover))]/50'}`}>
                        <input
                          type="radio"
                          name="attendance"
                          value={score}
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[hsl(var(--text-secondary))]">{SCORE_DESCRIPTIONS.attendance[score as 0 | 1 | 2]}</p>
                        </div>
                      </label>
                    ))}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {[0, 1, 2].map((score) => (
                      <label key={score} className={`flex items-start gap-3 p-2 rounded cursor-pointer border ${dailyScoreValues.quality === score ? 'bg-blue-500/20 border-blue-500/50' : 'bg-[hsl(var(--layout-bg))] border-[hsl(var(--layout-border))] hover:bg-[hsl(var(--layout-card-hover))]/50'}`}>
                        <input
                          type="radio"
                          name="quality"
                          value={score}
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[hsl(var(--text-secondary))]">{SCORE_DESCRIPTIONS.quality[score as 0 | 1 | 2]}</p>
                        </div>
                      </label>
                    ))}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {[0, 1, 2].map((score) => (
                      <label key={score} className={`flex items-start gap-3 p-2 rounded cursor-pointer border ${dailyScoreValues.eodrScore === score ? 'bg-blue-500/20 border-blue-500/50' : 'bg-[hsl(var(--layout-bg))] border-[hsl(var(--layout-border))] hover:bg-[hsl(var(--layout-card-hover))]/50'}`}>
                        <input
                          type="radio"
                          name="eodrScore"
                          value={score}
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[hsl(var(--text-secondary))]">{SCORE_DESCRIPTIONS.eodrScore[score as 0 | 1 | 2]}</p>
                        </div>
                      </label>
                    ))}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {[0, 1, 2].map((score) => (
                      <label key={score} className={`flex items-start gap-3 p-2 rounded cursor-pointer border ${dailyScoreValues.behaviour === score ? 'bg-blue-500/20 border-blue-500/50' : 'bg-[hsl(var(--layout-bg))] border-[hsl(var(--layout-border))] hover:bg-[hsl(var(--layout-card-hover))]/50'}`}>
                        <input
                          type="radio"
                          name="behaviour"
                          value={score}
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[hsl(var(--text-secondary))]">{SCORE_DESCRIPTIONS.behaviour[score as 0 | 1 | 2]}</p>
                        </div>
                      </label>
                    ))}
                  </div>
              ...
              <div className="space-y-2">
                <Label className="text-[hsl(var(--text-primary))]">Comments (optional)</Label>
                <Textarea
              ...
              <div className="bg-blue-500/10 p-3 rounded text-center border border-blue-500/30">
                <p className="text-sm text-[hsl(var(--text-secondary))]">Total Daily Score</p>
                {(() => {
                  ...
                  return (
                    <p className={`text-2xl font-bold ${isAboveNormal ? 'text-green-400' : isBelowNormal ? 'text-red-400' : 'text-blue-400'}`}>
                      {total}
                      <span className="text-base font-normal text-[hsl(var(--text-secondary))]"> / 4</span>
                    </p>
                  );
                })()}
                <p className="text-xs text-[hsl(var(--text-secondary))]">Baseline: 4 (1 per metric) • Above 4 = Exceptional</p>
              </div>
            </div>
          )}
          <DialogFooter>
            <Button variant="outline" onClick={() => setScoringMember(null)} className="border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]/50">
              Cancel
            </Button>
            <Button
